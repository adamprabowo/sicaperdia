...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 05, 2023 at 04:01 PM
...
CREATE TABLE `tbl_barang` (
  ...
  `kategori` varchar(10) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `tbl_kategori` (
  `id_kategori` varchar(3) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `tbl_stok_tahunan` (
  ...
  `kode_barang` varchar(50) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '0',
  `tahun` varchar(4) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '0',
  `harga` float DEFAULT '0',
  `jumlah_stok` int DEFAULT NULL,
  `jumlah_stok_terbaru` int DEFAULT NULL,
  `tanggal_diperbarui` date DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `tbl_stok_tahunan` (`id_stok`, `kode_barang`, `tahun`, `harga`, `jumlah_stok`, `jumlah_stok_terbaru`, `tanggal_diperbarui`) VALUES
(1, 'A001', '2023', 4500, 0, 4, '2023-07-05'),
(2, 'A002', '2023', NULL, 0, 0, '2023-01-01'),
(3, 'A003', '2023', NULL, 0, 0, '2023-01-01'),
(4, 'A004', '2023', NULL, 0, 0, '2023-01-01'),
(5, 'A005', '2023', 22500, 0, 11, '2023-07-05'),
(6, 'A006', '2023', NULL, 0, 0, '2023-01-01'),
(7, 'B001', '2023', NULL, 0, 0, '2023-01-01'),
(8, 'B002', '2023', 3000, 0, 45, '2023-07-05'),
(9, 'B003', '2023', NULL, 0, 0, '2023-01-01'),
(10, 'B004', '2023', NULL, 0, 0, '2023-01-01'),
(11, 'B005', '2023', NULL, 0, 0, '2023-01-01'),
(12, 'B006', '2023', NULL, 0, 0, '2023-01-01'),
(13, 'B007', '2023', NULL, 0, 0, '2023-01-01'),
(14, 'B008', '2023', NULL, 0, 0, '2023-01-01'),
(15, 'B009', '2023', NULL, 0, 0, '2023-01-01'),
(16, 'B0010', '2023', NULL, 0, 0, '2023-01-01'),
(17, 'B0011', '2023', NULL, 0, 0, '2023-01-01'),
(18, 'B0012', '2023', NULL, 0, 0, '2023-01-01'),
(19, 'B0013', '2023', NULL, 0, 0, '2023-01-01'),
(20, 'B0014', '2023', NULL, 0, 0, '2023-01-01'),
(21, 'B0015', '2023', NULL, 0, 0, '2023-01-01'),
(22, 'B0016', '2023', NULL, 0, 0, '2023-01-01'),
(23, 'B0017', '2023', NULL, 0, 0, '2023-01-01'),
(24, 'B0018', '2023', NULL, 0, 0, '2023-01-01'),
(25, 'B0019', '2023', NULL, 0, 0, '2023-01-01'),
(26, 'B0020', '2023', NULL, 0, 0, '2023-01-01'),
(27, 'B021', '2023', NULL, 0, 0, '2023-01-01'),
(28, 'B022', '2023', NULL, 0, 0, '2023-01-01'),
(29, 'B023', '2023', NULL, 0, 0, '2023-01-01'),
(30, 'B024', '2023', NULL, 0, 0, '2023-01-01'),
(31, 'B025', '2023', NULL, 0, 0, '2023-01-01'),
(32, 'B026', '2023', NULL, 0, 0, '2023-01-01'),
(33, 'B027', '2023', NULL, 0, 0, '2023-01-01'),
(34, 'B028', '2023', NULL, 0, 0, '2023-01-01'),
(35, 'B029', '2023', NULL, 0, 0, '2023-01-01'),
(36, 'B030', '2023', NULL, 0, 0, '2023-01-01'),
(37, 'B031', '2023', NULL, 0, 0, '2023-01-01'),
(38, 'B032', '2023', NULL, 0, 0, '2023-01-01'),
(39, 'B033', '2023', NULL, 0, 0, '2023-01-01'),
(40, 'B034', '2023', NULL, 0, 0, '2023-01-01'),
(41, 'B035', '2023', NULL, 0, 0, '2023-01-01'),
(42, 'B036', '2023', NULL, 0, 0, '2023-01-01'),
(43, 'B037', '2023', NULL, 0, 0, '2023-01-01'),
(44, 'B038', '2023', NULL, 0, 0, '2023-01-01'),
(45, 'B039', '2023', NULL, 0, 0, '2023-01-01'),
(46, 'B040', '2023', NULL, 0, 0, '2023-01-01'),
(47, 'B041', '2023', NULL, 0, 0, '2023-01-01'),
(48, 'B042', '2023', NULL, 0, 0, '2023-01-01'),
(49, 'B043', '2023', NULL, 0, 0, '2023-01-01'),
(50, 'B044', '2023', NULL, 0, 0, '2023-01-01'),
(51, 'B045', '2023', NULL, 0, 0, '2023-01-01'),
(52, 'B046', '2023', NULL, 0, 0, '2023-01-01'),
(53, 'B047', '2023', NULL, 0, 0, '2023-01-01'),
(54, 'B048', '2023', NULL, 0, 0, '2023-01-01'),
(55, 'B049', '2023', NULL, 0, 0, '2023-01-01'),
(56, 'B050', '2023', NULL, 0, 0, '2023-01-01'),
(57, 'B051', '2023', NULL, 0, 0, '2023-01-01'),
(58, 'B052', '2023', NULL, 0, 0, '2023-01-01'),
(59, 'B053', '2023', NULL, 0, 0, '2023-01-01'),
(60, 'C001', '2023', 68200, 85, 85, '2023-01-01'),
(61, 'C002', '2023', 5000, 0, 52, '2023-07-05'),
(62, 'C003', '2023', NULL, 0, 0, '2023-01-01'),
(63, 'C004', '2023', NULL, 0, 0, '2023-01-01'),
(64, 'C005', '2023', NULL, 0, 0, '2023-01-01'),
(65, 'C006', '2023', NULL, 0, 0, '2023-01-01'),
(66, 'C007', '2023', NULL, 0, 0, '2023-01-01'),
(67, 'C008', '2023', 55000, 125, 125, '2023-01-01'),
(68, 'C009', '2023', NULL, 0, 0, '2023-01-01'),
(69, 'C010', '2023', 55000, 338, 338, '2023-01-01'),
(70, 'C011', '2023', NULL, 0, 0, '2023-01-01'),
(71, 'C012', '2023', NULL, 0, 0, '2023-01-01'),
(72, 'C013', '2023', NULL, 0, 0, '2023-01-01'),
(73, 'C014', '2023', NULL, 0, 0, '2023-01-01'),
(74, 'D001', '2023', NULL, 0, 0, '2023-01-01'),
(75, 'D002', '2023', 510000, 18, 18, '2023-01-01'),
(76, 'D003', '2023', 1875000, 85, 85, '2023-01-01'),
(77, 'D004', '2023', NULL, 0, 0, '2023-01-01'),
(78, 'D005', '2023', NULL, 0, 0, '2023-01-01'),
(79, 'D006', '2023', NULL, 0, 0, '2023-01-01'),
(80, 'D007', '2023', 3540000, 167, 167, '2023-01-01'),
(81, 'D008', '2023', NULL, 0, 0, '2023-01-01'),
(82, 'D009', '2023', NULL, 0, 0, '2023-01-01'),
(83, 'D010', '2023', NULL, 0, 0, '2023-01-01'),
(84, 'E001', '2023', 4717.5, 113750, 113750, '2023-01-01'),
(85, 'E002', '2023', 115450, 66, 66, '2023-01-01'),
(86, 'E003', '2023', 115450, 31, 31, '2023-01-01'),
(87, 'E004', '2023', 115450, 53, 53, '2023-01-01'),
(88, 'E005', '2023', 115450, 95, 95, '2023-01-01'),
(89, 'E006', '2023', 139600, 10, 10, '2023-01-01'),
(90, 'E007', '2023', 88000, 10, 10, '2023-01-01'),
(91, 'E008', '2023', 88000, 10, 10, '2023-01-01'),
(92, 'E009', '2023', 88000, 10, 10, '2023-01-01'),
(93, 'E010', '2023', 88000, 20, 20, '2023-01-01'),
(94, 'E011', '2023', 35520, 900, 900, '2023-01-01'),
(95, 'E012', '2023', 47190, 234, 234, '2023-01-01'),
(96, 'E013', '2023', 94490, 50, 50, '2023-01-01'),
(97, 'F001', '2023', NULL, 0, 0, '2023-01-01'),
(98, 'F002', '2023', NULL, 0, 0, '2023-01-01'),
(99, 'F003', '2023', NULL, 0, 0, '2023-01-01'),
(100, 'F004', '2023', NULL, 0, 0, '2023-01-01'),
(101, 'F005', '2023', NULL, 0, 0, '2023-01-01'),
(102, 'F006', '2023', NULL, 0, 0, '2023-01-01'),
(103, 'F007', '2023', NULL, 0, 0, '2023-01-01'),
(104, 'F008', '2023', NULL, 0, 0, '2023-01-01'),
(105, 'F009', '2023', NULL, 0, 0, '2023-01-01'),
(106, 'F010', '2023', NULL, 0, 0, '2023-01-01'),
(107, 'F011', '2023', NULL, 0, 0, '2023-01-01'),
(108, 'F012', '2023', NULL, 0, 0, '2023-01-01'),
(109, 'F013', '2023', NULL, 0, 0, '2023-01-01'),
(110, 'F014', '2023', NULL, 0, 0, '2023-01-01'),
(111, 'F015', '2023', NULL, 0, 0, '2023-01-01'),
(112, 'F016', '2023', NULL, 0, 0, '2023-01-01'),
(113, 'F017', '2023', NULL, 0, 0, '2023-01-01'),
(114, 'F018', '2023', NULL, 0, 0, '2023-01-01'),
(115, 'F019', '2023', NULL, 0, 0, '2023-01-01'),
(116, 'F020', '2023', NULL, 0, 0, '2023-01-01'),
(117, 'F021', '2023', NULL, 0, 0, '2023-01-01');
...
CREATE TABLE `tbl_transaksi` (
  ...
  `kode_barang` varchar(10) COLLATE utf8mb4_general_ci NOT NULL,
  `keterangan` text COLLATE utf8mb4_general_ci NOT NULL COMMENT 'stok, pembelian, mutasi',
  `jumlah` int NOT NULL,
  `harga` int NOT NULL,
  `no_bukti` varchar(20) COLLATE utf8mb4_general_ci NOT NULL,
  `status` int NOT NULL COMMENT '0 stok, 1 in, 2 out',
...
--
ALTER TABLE `tbl_barang`
  MODIFY `id_barang` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=118;

--
-- AUTO_INCREMENT for table `tbl_stok_tahunan`
--
ALTER TABLE `tbl_stok_tahunan`
  MODIFY `id_stok` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=118;
